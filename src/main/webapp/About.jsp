...
<!-- Login as -->
  ...
  <div class="card d-flex flex-row" style="width: 60rem; height: 20rem; margin-top: -50px;">
    ...
    <div class="card-body text-center d-flex flex-column justify-content-center" style="width: 50%;">
      <h5 class="card-title">About Rural-E-Health</h5>
      <p style="text-align: justify;">Rural-E-Health is a digital healthcare initiative designed to bridge the gap between rural communities and quality medical services. Our platform enables seamless coordination between doctors, receptionists, and patients ensuring timely care, expert consultations, and access to essential health information.


Our mission is to simplify healthcare delivery in rural regions using technology ensuring that no individual is left behind in receiving timely and appropriate medical support.</p>
    </div>
