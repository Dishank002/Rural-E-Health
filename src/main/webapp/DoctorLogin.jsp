...
<div class="form-box" style="background-image: linear-gradient(to right top, #bd6bf4, #a07afb, #8387fd, #6790fa, #4f97f4) !important; margin-top:50px; padding: 30px; width:60rem;">
  <div style="display: flex; align-items: center; justify-content: space-between; gap: 20px;">
    ...
    <!-- Left Side: Form -->
    <form action="DoctorLoginServlet" method="post" style="flex: 1;">
      <div class="mb-3">
        <h3 style="text-align: center;"><i class="fa-solid fa-user"></i> Welcome Doctor</h3><br>
      ...
      <span>Not Registered yet? <a href="AddDoctor.jsp">Register here</a></span><br><br>
