...
<body
  ...
  <div class="container-fluid">
	...
	<div class="form-box"
		...
		<input type="hidden" name="submittedBy" value="<%= session.getAttribute("adminLoggedIn") != null ? "admin" : "self" %>">
			<h2 style="text-align: center;">Receptionist Registration</h2>
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control" id="doctorName" name="email" required>
			</div>
			<div class="mb-3">
