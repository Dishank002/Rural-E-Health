...
<!-- Login as -->
  ...
  <div class="card d-flex flex-row" style="width: 60rem; height: 20rem; margin-top: -50px;">
    ...
    <div class="card-body text-center d-flex flex-column justify-content-center" style="width: 50%;">
      ...
      <a href="AdminLogin.jsp" class="btn btn-primary m-2 loginas-btn">Admin</a>
      <a href="DoctorLogin.jsp" class="btn btn-primary m-2 loginas-btn">Doctor</a>
      <a href="ReceptionistLogin.jsp" class="btn btn-primary m-2 loginas-btn">Receptionist</a>
    </div>
